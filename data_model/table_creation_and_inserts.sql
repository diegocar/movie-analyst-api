...
-- CREATE TABLE movie_db.reviewpending (title VARCHAR(255) PRIMARY KEY, `release` VARCHAR(255), score INTEGER, reviewer VARCHAR(255), FOREIGN KEY (reviewer) REFERENCES reviewer(name) ON DELETE CASCADE);
...
-- INSERT INTO movie_db.reviewpending (title, `release`, score, reviewer) VALUES ('Superman : Homecoming', '2017', 11, 'Chris Harris');
-- INSERT INTO movie_db.reviewpending (title, `release`, score, reviewer) VALUES ('Wonder Woman', '2017', 8, 'Martin Thomas');
-- INSERT INTO movie_db.reviewpending (title, `release`, score, reviewer) VALUES ('Doctor Strange', '2016', 7, 'Anthony Miller');